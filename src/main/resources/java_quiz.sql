...
VALUES
       ...
       (37, 'обязателен к реализации у классах наслежниках','не обязателен к реализации у классах наследниках', 'необходимо реализовать в абстрактном классе', 'является ошибкой', 'Если у абстрактного имеется метод с модификатором abstract, то он...'),
       (38, 'нет','если есть модификатор "private"', 'да', 'если есть модификатор "public"', 'Можно ли создавать экземпляры абстрактных класссов?'),