...
VALUES
       ...
       (115, 'min()','max()','swap()','shuffle()','Какого метод класса Collections возвращает минимальный элемент коллекции в соответствии с естественным порядком ее элементов?'),
       (116, 'max()','min()','swap()','shuffle()','Какого метод класса Collections возвращает максимальный элемент коллекции в соответствии с естественным порядком ее элементов?'),
