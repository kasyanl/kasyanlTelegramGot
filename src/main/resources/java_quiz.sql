...
VALUES
       ...
       (92, 'можно, если они одного типа','нельзя', 'можно, если они имеют разные типа','тип объектов не имеет значение', 'Можно ли двум и более объектам присваивать одну и ту же ссылку на объект')
